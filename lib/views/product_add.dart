...
//   {
//     "name": "Hamburger 12312312312",
//     "picture": "http://localhost:8000/storage/img/default.png",
//     "picture_ori": "",
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                          hintText: "Masukkan kode makanan",
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      await parser.httpPost(UrlList.addProduct, body: {
                        ...
                        if (value?.statusCode == 201) {
                          ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(content: Text("Berhasil menambah")));
                        }
                      }).whenComplete(() {
                        setState(() {
                          loading = false;
